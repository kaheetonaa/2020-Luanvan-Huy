...
\geometry{a4paper, top=3.5cm, inner=3.5cm, outer=2cm, bottom=3cm, headheight=120pt}
...
\rhead{\fontsize{10}{12} \selectfont Giảng viên hướng dẫn:\\TS. }					% Header bên phải
\lhead{\fontsize{10}{12} \selectfont Đề tài:\\}									% Header bên trái
\rfoot{\fontsize{10}{12} \selectfont \thepage}											% Footer bên phải
\lfoot{\fontsize{10}{12} \selectfont Nguyễn Quang Huy}							% Footer bên trái

\begin{document}
\newgeometry{a4paper, top=3.5cm, inner=3cm, outer=3cm, bottom=3cm, headheight=120pt}
